...
simulate()
{
export GEM5_PATH="/constantine/src/gem5"
...
c_benchmarks="openssl/tls1_cbc_remove_padding_lucky13_wrapper bearssl/aes_big_wrapper bearssl/des_tab_wrapper"
declare -A bench_to_lib=( ["openssl/tls1_cbc_remove_padding_lucky13_wrapper"]="" ["bearssl/aes_big_wrapper"]="bearssl/bearssl.bc" ["bearssl/des_tab_wrapper"]="bearssl/bearssl.bc")
